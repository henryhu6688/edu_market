...
func TestMain(m *testing.M) {
	...
	config.App = &config.Config{
		...
		Agent:   config.AgentConfig{MaxToolRounds: 10, ContextMaxMsg: 20, ChunkSize: 500, ChunkOverlap: 50, EmbeddingModel: "BAAI/bge-large-zh-v1.5", EmbeddingAPIURL: "https://api.siliconflow.cn/v1/embeddings"},
